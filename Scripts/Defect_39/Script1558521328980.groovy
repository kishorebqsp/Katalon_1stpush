...
WebUI.click(findTestObject('My_pro_img/Page_EduRary  Courses/img_my course_img-circle'))

WebUI.click(findTestObject('My_profile/Page_EduRary  Courses/a_my profile'))

WebUI.click(findTestObject('Loadd_more/Page_EduRary  My Profile/a_Load More'))
