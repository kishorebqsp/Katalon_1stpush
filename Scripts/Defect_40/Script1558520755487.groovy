...
WebUI.click(findTestObject('Soft_skills_tab/Page_EduRary  Courses/span_Soft Skills'))

WebUI.click(findTestObject('Core_java_tab/Page_EduRary  Soft Skills/img_soft-skills_image-3'))
