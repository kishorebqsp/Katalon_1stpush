...
WebUI.scrollToPosition(1, 10)

WebUI.delay(10)

WebUI.click(findTestObject('No_pause_to_learning/Page_Courses/a_No Pause to learning'))

WebUI.click(findTestObject('Social_media/Page_EduRary  Blog/span_Social Media'))
