...
WebUI.click(findTestObject('Profile/Page_Courses/img_my course_img-circle lazy'))

WebUI.delay(5)

WebUI.click(findTestObject('My_Profile/Page_Profile page meta title/a_my profile'))
...
WebUI.click(findTestObject('Load_more_button/Page_Profile page meta title/a_Load More'))
