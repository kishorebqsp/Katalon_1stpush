...
WebUI.setText(findTestObject('course_name/Page_EduRary  My Courses/input_What do you want to teach_coursename'), 'katalon1')

WebUI.delay(5)

WebUI.click(findTestObject('Radio_buttonabc/Page_EduRary  My Courses/div_Yes'))
