...
WebUI.setText(findTestObject('Assessment_name_tb/Page_EduRary  My Courses/input_Assessment Name_assessmentname'), 'yash')

WebUI.setText(findTestObject('Assessment_slug_tb/Page_EduRary  My Courses/input_Assessment Slug_assessmentslug'), 'yash2239')
...
WebUI.click(findTestObject('Add_des/Page_EduRary  Create Course/input_Introduction_lecture_add_content'))

WebUI.delay(5)

WebUI.setText(findTestObject('Give_description_tb/Page_EduRary  Create Course/div_Reset to default_note-editable panel-body'), 
    'asdfghjklasdfghjkl')
