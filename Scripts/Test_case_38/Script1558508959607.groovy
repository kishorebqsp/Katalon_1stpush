...
WebUI.setText(findTestObject('Assessment_slug_tb/Page_EduRary  My Courses/input_Assessment Slug_assessmentslug'), 'sel46')
...
WebUI.setText(findTestObject('Subtitle_det/Page_EduRary  Create Course/textarea_SubTitle_subtitle'), 'qwertyuioplkjhgfdsazxcvbnm')
