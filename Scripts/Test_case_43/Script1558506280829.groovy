...
WebUI.setText(findTestObject('Assessment_slug_tb/Page_EduRary  My Courses/input_Assessment Slug_assessmentslug'), 'sel31')

WebUI.click(findTestObject('Create_button/Page_EduRary  My Courses/button_Create'))

WebUI.click(findTestObject('Privacy_button/Page_EduRary  Create Course/span_  Privacy'))

WebUI.click(findTestObject('Public_button/Page_EduRary  Create Course/a_Public'))
