...
WebUI.click(findTestObject('Preview_button/Page_Create Course/a_Preview'))

WebUI.click(findTestObject('As_Guest/Page_Create Course/a_As Guest'))

WebUI.delay(10)

WebUI.closeWindowTitle('Course')
