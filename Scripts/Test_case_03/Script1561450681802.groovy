...
WebUI.setText(findTestObject('course_name/Page_EduRary  My Courses/input_What do you want to teach_coursename'), 'asdfbnm')

WebUI.click(findTestObject('Yess/Page_My course page meta title/input_Yes_coursetype_sel'))

WebUI.setText(findTestObject('Course_slug_create_c/Page_EduRary  My Courses/input_Course Slug_slug'), 'ahjk')
