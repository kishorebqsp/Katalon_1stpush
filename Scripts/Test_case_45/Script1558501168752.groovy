...
WebUI.click(findTestObject('Submit_button/Page_/button_Submit'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Assessment_slug_tb/Page_EduRary  My Courses/input_Assessment Slug_assessmentslug'), 'sel111')

WebUI.click(findTestObject('Create_button/Page_EduRary  My Courses/button_Create'))

WebUI.click(findTestObject('Manage_instructor/Page_EduRary  Create Course/span_ Manage Instructors'))

WebUI.setText(findTestObject('Enter_email/Page_EduRary  Create Course/input_Yash Sahay_instructorname'), 'Bharanigramesh28@gmail.com')

WebUI.click(findTestObject('Add_instructor_button/Page_EduRary  Create Course/input_Yash Sahay_addinstructors'))
